...
MB_Log_Parser::MB_Log_Parser(const QString &file_name)
{
    m_time_start = -1;
...
void MB_Log_Parser::set_addition_log_key(bool key) noexcept
{
    m_is_addition_log = key;
}

bool MB_Log_Parser::parse(const QString &line, W_Log_Data *result)
{
